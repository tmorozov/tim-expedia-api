...
templates['rooms'] = template({"1":function(depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "<li>\r\n  <fieldset >\r\n    <legend style=\"position: relative; left: 10px;\">Room "
    ...
    + "</legend>\r\n\r\n    <label class=\"grid-25\">\r\n      <span>Adults<span>(18+)</span></span>\r\n      <select class=\"js-adults-count\" name=\"rooms["
    ...
    + "    </fieldset>\r\n\r\n    <label class=\"grid-10\">\r\n      <span>Remove room</span>\r\n      <button class=\"js-remove-room\" data-room=\""
    + alias2(((helper = (helper = helpers.index || (data && data.index)) != null ? helper : alias1),(typeof helper === alias3 ? helper.call(depth0,{"name":"index","hash":{},"data":data}) : helper)))
    + "\">X</button>\r\n    </label>\r\n\r\n  </fieldset>\r\n</li>\r\n";
  ...
  return "        <li class=\"grid-30\">\r\n          <label>\r\n            <select class=\"js-child-age\" name=\"rooms["
